...
class _ChatRoomListTileState extends State<ChatRoomListTile> {
  ...
  getThisUserInfo() async {
    ...
    DateTime sent = widget.time.toDate();
    var formatter = new DateFormat('dd-MM-yyyy');
    String currentDate = formatter.format(now);
    String sentdate = formatter.format(sent);
    if(sentdate == currentDate){
      sentTime = DateFormat('kk:mm:a').format(sent);
    } else {
      sentTime = "${sent.day.toString()}/${sent.month.toString()}/${sent.year.toString()}";
    }
    setState(() {});
  }
